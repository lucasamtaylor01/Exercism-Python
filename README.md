...
## 📚 Curso de Python na Udemy / Python Course on Udemy

Estou inscrito no curso "Python 3 - Do Zero ao Avançado" na Udemy.
/
I am enrolled in the "Python 3 - From Zero to Advanced" course on Udemy. (Available  only in portuguese)
...
A estrutura deste repositório reflete a organização dos tópicos abordados nos exercícios do Exercism.
/
